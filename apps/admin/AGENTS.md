...
- Managed setup stores its renewable OAuth credential; an account-owned token is connected by the operator directly on the Admin origin and never passes through discoflare.com.
